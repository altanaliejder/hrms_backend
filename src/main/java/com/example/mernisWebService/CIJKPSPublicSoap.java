...
public class CIJKPSPublicSoap
{
    ...
    public CIJKPSPublicSoap(){}

    public CIJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CIJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CIJExtendedSoapSerializationEnvelope envelope= new CIJExtendedSoapSerializationEnvelope(CIJExtendedSoapSerializationEnvelope.VER11);
