...
public class CIJExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CIJDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CIJStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CIJDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CIJDateTimeConverter dateTimeConverter = new CIJStandardDateTimeConverter();

    public CIJExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CIJExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CIJMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CIJHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CIJExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CIJHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
